...
**禁止**在此把 25 条每条写成迷你教程，避免与 [`confirmation-bias`](../confirmation-bias/SKILL.md)、[`availability-heuristic`](../availability-heuristic/SKILL.md)、[`loss-aversion`](../loss-aversion/SKILL.md) 等重复堆砌。
...
| 5 | 避免不一致 | 死守旧承诺与自我形象以维持一致 | [`sunk-cost`](../sunk-cost/SKILL.md) / [`confirmation-bias`](../confirmation-bias/SKILL.md) |
| 6 | 好奇心 | 探索欲；可对冲部分误判 | —（保护性倾向） |
| 7 | 康德式公平 | 对绝对公平的执念扭曲交易 | — |
| 8 | 艳羡/妒忌 | 相对地位驱动决策 | — |
| 9 | 回馈 | 互惠与以牙还牙过冲 | — |
| 10 | 简单联想 | 符号/刻板联想替代因果 | — |
| 11 | 避免痛苦的心理否认 | 拒认痛苦事实 | 常叠用 [`confirmation-bias`](../confirmation-bias/SKILL.md) |
| 12 | 自视过高 | 高估自己与所有物 | [`dunning-kruger`](../dunning-kruger/SKILL.md) |
| 13 | 过度乐观 | 愿望当概率 | [`prospect-theory`](../prospect-theory/SKILL.md) |
| 14 | 被剥夺超级反应 | 对损失/差点失去的过激反应 | [`loss-aversion`](../loss-aversion/SKILL.md) / [`prospect-theory`](../prospect-theory/SKILL.md) |
| 15 | 社会认同 | 从众替代独立判断 | [`spiral-of-silence`](../spiral-of-silence/SKILL.md) |
| 16 | 对比错误反应 | 被对照物顺序/反差带偏 | — |
| 17 | 压力影响 | 过强压力损害认知 | — |
| 18 | 易得性错误衡量 | 生动易提案例权重过高 | [`availability-heuristic`](../availability-heuristic/SKILL.md) |
...
证据筛选类误判常与 [`confirmation-bias`](../confirmation-bias/SKILL.md) 叠用：芒格清单命中“避免不一致 / 否认 / 热爱”等时，用确认偏差 skill 做证据对抗。
...
- **与[确认性偏差](../confirmation-bias/SKILL.md)**：证据过滤的专用手术刀；芒格命中相关倾向时路由过去。
