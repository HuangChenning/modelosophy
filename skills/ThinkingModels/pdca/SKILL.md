...
- **与[飞轮](../flywheel/SKILL.md)**：飞轮定义推哪一环；PDCA 迭代怎么推。
- **与[系统思维](../systems-thinking/SKILL.md)**：Check 发现反弹时，升级画回路再 Plan。
- **与[逆向思维](../inversion/SKILL.md)**：Plan 阶段可用事前验尸列出失败模式。
- **与[双系统](../dual-process/SKILL.md)**：标准化（Act）把反复验证的做法交给习惯/System 1，节省慢思考。
---
